...
public class GiantWolfSkeletonEntity extends TameableEntity implements Angerable {
    ...
    public static DefaultAttributeContainer.Builder createGiantWolfSkeletonAttributes() {
        return MobEntity.createMobAttributes()
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.30000001192092896D * 1.25F)
    ...
    public void tick() {
        ...
        if (this.isAlive()) {
            if (this.hasAngerTime()) {
                this.getAttributeInstance(EntityAttributes.GENERIC_MOVEMENT_SPEED).setBaseValue(0.30000001192092896D * 2.0F);
